...
// Para dibujar la grfica
@Composable
fun RadarChartComparativaGlobal(
    ...
    Canvas(modifier = modifier.height(300.dp).fillMaxWidth()) {
        ...
        comparacionEntries?.let {
            ...
            drawPath(
                ...
                color = Color(0xFF8BC34A).copy(alpha = 0.25f)
            )
...
//HACER COMPROBACIONES Y BORRAR ESTA FUNCION SI ES NECESARIO
/*// Función auxiliar para mostrar la gráfica en una pantalla
@Composable
fun RadarChartSection(
    ...
    Column(
        ...
        RadarChartComparativaGlobal(entries = entries, comparacionEntries = comparacionEntries)
    }
}*/
